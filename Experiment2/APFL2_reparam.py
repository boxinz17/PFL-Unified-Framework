...
def train_GD(w0, beta0, n_epochs, train_loader_list, lambda_global, \
    ...
    for epoch in range(1, n_epochs + 1):
        ...
        if epoch == 1 or epoch % repo_step == 0:
            ...
            print("epoch: {}, loss: {:.10f}, time pass: {}s | GD {} {} Reparam".format(epoch, loss, pass_time, obj, data_name))
...
def train_SGD(w0, beta0, n_epochs, devices_train_list, train_loader_list, \
    ...
    for epoch in range(1, n_epochs + 1):
        ...
        if epoch == 1 or epoch % repo_step == 0:
            now_time = datetime.datetime.now()
            pass_time = (now_time - start_time).seconds
            print("epoch: {}, loss: {:.10f}, time pass: {}s | SGD {} {} Reparam".format(epoch, loss, pass_time, obj, data_name))
...
def train_CD(w0, beta0, n_epochs, devices_train_list, train_loader_list, \
    ...
    for epoch in range(1, n_epochs + 1):
        ...
        if epoch == 1 or epoch % repo_step == 0:
            now_time = datetime.datetime.now()
            pass_time = (now_time - start_time).seconds
            print("epoch: {}, loss: {:.10f}, time pass: {}s | CD {} {} Reparam".format(epoch, loss, pass_time, obj, data_name))
    ...
    while num_commun < n_communs:
        ...
        if num_commun == 1 or num_commun % repo_step == 0:
            if num_commun not in reported_commun:
                ...
                now_time = datetime.datetime.now()
                pass_time = (now_time - start_time).seconds
                print("num_commun: {}, loss: {:.10f}, time pass: {}s | CDVR {} {} Reparam".format(num_commun, loss, pass_time, obj, data_name))
...
def train_local_sgd(w_list0, beta_list0, alpha_list, sync_step, n_epochs, devices_train_list, train_loader_list, 
    ...
    for epoch in range(1, n_epochs + 1):
        # Synchronization
        if epoch == 1 or epoch % sync_step == 0:
        ...
        # Compute the loss
        loss = loss_fn_local_sgd(w_list_curr, beta_list_curr, train_loader_list, 
                                 lambda_global, alpha_list)
        ...
        if epoch == 1 or epoch % repo_step == 0:
            now_time = datetime.datetime.now()
            pass_time = (now_time - start_time).seconds
            print("epoch: {}, loss: {:.15f}, time pass: {}s | Local_SGD {} {} Reparam".format(epoch, loss, pass_time, obj, data_name))
