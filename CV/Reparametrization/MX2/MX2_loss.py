...
def loss_fn(w, beta_list, train_loader_list, lambda_penal, device):
...
def loss_fn_norescale(w, beta_list, train_loader_list, lambda_penal, device):
    # Define loss functions
    loss_CE_fn = nn.CrossEntropyLoss()
    penalty_fn = nn.MSELoss(reduction='sum')
...
def F_grads(w, beta_list, train_loader_list, lambda_penal, device):
    # Define loss functions
    loss_CE_fn = nn.CrossEntropyLoss()
    penalty_fn = nn.MSELoss(reduction='sum')
...
def F_grads_norescale(w, beta_list, train_loader_list, lambda_penal, device):
    # Define loss functions
    loss_CE_fn = nn.CrossEntropyLoss()
    penalty_fn = nn.MSELoss(reduction='sum')
...
def fmj_grads(w, beta_list, index_choice, devices_train_list, lambda_penal, device):
...
def fmj_grads_norescale(w, beta_list, index_choice, devices_train_list, lambda_penal, device):
    # Return: A list of grads w.r.t. beta_m's
    loss_CE_fn = nn.CrossEntropyLoss()
    penalty_fn = nn.MSELoss(reduction='sum')
...
def fmj_grads_LSGD(w_list, beta_list, index_choice, devices_train_list, lambda_penal, device):
    loss_CE_fn = nn.CrossEntropyLoss()
    penalty_fn = nn.MSELoss(reduction='sum')
...
def fmj_grads_LSGD_norescale(w_list, beta_list, index_choice, devices_train_list, lambda_penal, device):
    loss_CE_fn = nn.CrossEntropyLoss()
    penalty_fn = nn.MSELoss(reduction='sum')
