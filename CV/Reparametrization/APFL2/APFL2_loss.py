...
def loss_fn(w, beta_list, train_loader_list, lambda_global, alpha_list, device):
...
def loss_fn_norescale(w, beta_list, train_loader_list, lambda_global, alpha_list, device):
    # Define loss functions
    loss_CE_fn = nn.CrossEntropyLoss()
    penalty_fn = nn.MSELoss(reduction='sum')
...
def F_grads(w, beta_list, train_loader_list, lambda_global, alpha_list, device):
    # Define loss functions
    loss_CE_fn = nn.CrossEntropyLoss()
    penalty_fn = nn.MSELoss(reduction='sum')
...
def F_grads_norescale(w, beta_list, train_loader_list, lambda_global, alpha_list, device):
    # Define loss functions
    loss_CE_fn = nn.CrossEntropyLoss()
    penalty_fn = nn.MSELoss(reduction='sum')
...
def fmj_grads(w, beta_list, index_choice, devices_train_list, lambda_global, alpha_list, device):
...
def fmj_grads_norescale(w, beta_list, index_choice, devices_train_list, lambda_global, alpha_list, device):
    # Return: A list of grads w.r.t. beta_m's
    loss_CE_fn = nn.CrossEntropyLoss()
    penalty_fn = nn.MSELoss(reduction='sum')
...
def fmj_grads_LSGD(w_list, beta_list, index_choice, devices_train_list, lambda_global, alpha_list, device):
    loss_CE_fn = nn.CrossEntropyLoss()
    penalty_fn = nn.MSELoss(reduction='sum')
...
def fmj_grads_LSGD_norescale(w_list, beta_list, index_choice, devices_train_list, lambda_global, alpha_list, device):
    loss_CE_fn = nn.CrossEntropyLoss()
    penalty_fn = nn.MSELoss(reduction='sum')
