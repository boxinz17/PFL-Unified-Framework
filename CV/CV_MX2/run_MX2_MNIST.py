...
val_loader_list, lambda_penal, eta, p_w, theta, nu, gamma, repo_step, device, rd_seed=111)
...
train_loader_list, val_loader_list, lambda_penal, eta, p_w, rho, theta1, theta2, nu, gamma, repo_step, device, 
rd_seed=rd_seed)
